    ...
    <div class="row">
        <div class="col-lg-3">
            <div class="profile-box-order p-3">
                ...
                <hr>
                <a href=""> <i class="fas fa-user fa-user2 ml-2" aria-hidden="true"></i> مشاهده و ویراش حساب کاربری </a>
                <hr>
                <a href="{{route('user.orders.form')}}"> <i class="fas fa-scroll fa-scroll1 ml-2"

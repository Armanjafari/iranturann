...
<header>
    <nav class="navigation text-right">
        <div class="container">
            <ul class="menu-level-1">
                <!-- Menu Level 1 -->
                <img src="{{ asset('assets/img/svg element/Asset7iranturan.com.svg') }}" alt="" class="img-thumbnail ml-5">
                <li class="menu-list-1">
                    ...
                    <ul class="menu-level-2">
                        ...
                        <li class="menu-list-2">
                            <a href="#" class="list-item">
                                <img src="{{ asset('assets/img/arrow-level2.png') }}" alt="mobile">
                                <span>موبایل</span>
                            </a>
                        ...
                        <li class="menu-list-2"><a href="#" class="list-item">
                                <img src="{{ asset('assets/img/arrow-level2.png') }}" alt="tablet book reader">
                                <span>لپ تاب</span>
                            </a></li>
                        <li class="menu-list-2"><a href="#" class="list-item">
                                <img src="{{ asset('assets/img/arrow-level2.png') }}" alt="tablet book reader">
                ...
                <li class="menu-list-1"><a href="#" class="list-item">
                        ...
                        <img class="item-icon" src="{{ asset('assets/img/download.png') }}" alt="">
                    </a></li>
                <li class="menu-list-1"><a href="#" class="list-item">
    ...
    <div class="mobile-nav">
        ...
        <img src="{{ asset('assets/img/svg element/Asset7iranturan.com.svg') }}" alt="" class="img-thumbnail ml-auto mr-5">
        <img src="{{ asset('assets/img/svg element/Iconawesome-shopping-cart.svg') }}" alt="" class="svg-shopp ml-4">
        <img src="assets/img/svg element/" alt="" class="mt-1">

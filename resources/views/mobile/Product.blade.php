          ...
          <a class="prev" onclick="plusSlides(-1)">❮</a> -->
                <div class="row">
                    ...
                    @for ($i = 1; $i<$product->pure->images()->count() ; $i++)
                        <div class="column">
                            <img class="demo cursor" src="{{$product->pure->images->first()->address}}"
                                onclick="CurrentSlide($i)" style="width:100%" alt="">
                        </div>
                        @endfor
                </div>
            </div>
            ...
            <div class="card text-right border-0 h-100">
                <div class="card-body">
                    ...
                    <div class="mt-3 box-brand mr-3">
                        ...
                        <a href="{{ route('product.by.category', $option->product->pure->category->id) }}"
                            class="link-brand">
                    ...
                    <div class="mt-3 color-product-box mr-3">
                        ...
                        {{-- <form style="display: inline" action="{{ route('product.single' , $full->id) }}" method="GET"> --}}
                            <a class="rounded-circle d-inline-block mr-2 mt-2 color-boreder {{ $option->id ==  $full->id ? 'active-color' : ''}}"
                                ...
                                href="{{ route('mobile.product.single' ,['market' => $market->id , 'option'=>$full->id]) }}"></a>
                        {{-- </form> --}}
                        @empty
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-lg-4">
                                                ...
                                                <div class="mt-5">
                                                    <a class="Add-to-cart1 float-right" data-toggle="modal"
                                                        data-target="#exampleModal">افزودن دیدگاه</a>
                                                    <div class="ml-5">
                                                                ...
                                                                <div class="modal-content">
                                                                    <div class="modal-header">
                                                                        ...
                                                                        <h5 class="modal-title ml-auto"
                                                                            id="exampleModalLabel">دیدگاه خود را بیان
                                                                            کنید.</h5>
                                                                    </div>
                                                                    <div class="modal-body text-center">
                                                                        <textarea name="" id="" class="mybor" id="mybor"
                                                                            cols="30" rows="10"></textarea>
                                                                    </div>
                                                                    <div class="modal-footer">
                                                                        <button type="button" class="btn btn-secondary"
                                                                            data-dismiss="modal">خروج</button>
                                                                        <a class="btn btn-primary mr-3" href="">افزودن
                                                                            دیدگاه</a>
                                                                    </div>
                                                                </div>
                                                            </div>
                                            ...
                                            <div class="col-lg-8">
                                                ...
                                                <div class="card mt-3 p-3 card-coment">
                                                    ...
                                                    <p class="text-right mt-2">از نظر کیفیت خوب بود اما قیمتش نسبتا بالا
                                                        بود
                                                    </p>
                                                    <div class="text-center">
                                                        <a href="">تایید دیدگاه</a>
                                                        <span class="mr-3">3</span>
                                                        <img src="{{asset('assets/img/لایک.svg')}}" alt=""
                                                            class="dis-like mr-2">
                                                        <img src="{{asset('assets/img/دیس لایک.svg')}}" alt=""
                                                            class="dis-like mr-2 mt-2">
                                                    </div>
                                                    <span class="text-right mt-2">‏26 خرداد 1400</span>
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-lg-4">
                                                ...
                                                <div class="mt-5">
                                                    <a class="Add-to-cart1 float-right" data-toggle="modal"
                                                        data-target="#exampleModal1">ثبت پرسش</a>
                                                    <div class="ml-5">
                                                        <!-- <textarea name="" id=""  class="mybor" id="mybor" cols="30" rows="10"></textarea> -->
                                                        <!-- Modal -->
                                                            ...
                                                            <div class="modal-dialog" role="document">
                                                                <div class="modal-content">
                                                                    <div class="modal-header">
                                                                        ...
                                                                        <h5 class="modal-title ml-auto"
                                                                            id="exampleModalLabel">سوال خود را در مورد
                                                                            این کالا بیان کنید</h5>
                                                                    </div>
                                                                    <div class="modal-body text-center">
                                                                        <textarea name="" id="" class="mybor" id="mybor"
                                                                            cols="30" rows="10"></textarea>
                                                                    ...
                                                                    <div class="modal-footer">
                                                                        <button type="button" class="btn btn-secondary"
                                                                            data-dismiss="modal">خروج</button>
                                                                        <a class="btn btn-primary mr-3" href="">ثبت
                                                                            پرسش</a>
                                                                    </div>
                                                                </div>
                                                            </div>
                                            ...
                                            <div class="col-lg-8">
                                                ...
                                                <div class="card mt-3 p-3 card-coment">
                                                    <div class="text-right">
                                                        ...
                                                        <p class=" mt-3 d-inline-block">آیا محصول با کد A23را می توان به
                                                            صورت عمده خرید کرد؟
                                                        </p>
                                                    </div>

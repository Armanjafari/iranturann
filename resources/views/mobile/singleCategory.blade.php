            ...
            <div class="row m-0">
                <div class="col-4 pl-0">
                    <div class="text-right category2">
                        <a href="{{ url()->previous() }}">
                            <img src="{{asset('assets/mobile/img/svg/1303887_arrow_arrows_circle_direction_forward_icon.svg')}}" class="svg-back"
                                alt="">
                        </a>
                    </div>
                </div>
                <div class="col-8 text-right  category2">
                    <span href="" class="categry1 font12 font-weight-bold">{{$category->persian_name}}</span>
                </div>
            </div>
        </div>
        <!-- start box product -->

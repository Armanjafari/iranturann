...
<body dir="rtl">
                                ...
                                <ul class="menu-level-3">
                                    ...
                                    <li class="menu-list-3">
                                        <ul class="menu-level-last">
                                            ...
                                            <li class="menu-list-last"><img src="img/level3-item-icon.png"
    ...
    <main><br>
                ...
                <div class="card  border-color-promiry">
                    ...
                    <div class="card-body text-right  col-md-12">
                        <div id="first_name" class="mt-5 mr-lg-5">
                            ...
                            <input type="text" class="form-control input-lg w-75 form-control-2"
                                placeholder="شماره موبایل خود را وارد نمایید">
                        </div>
                        <div id="first_name" class="mt-5 mr-lg-5">
                            <label>رمز</label>
                            <input type="text" class="form-control input-lg w-75 form-control-3"
        ...
        <div class="text-center ml-lg-5">
            <button type="button" class="button mt-5  pt-3 pb-3 btn-login"><a href="#" class="sign-up">ورود به
                    سیستم</a></button>
        </div>
        </div>
        </div>

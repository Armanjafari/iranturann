        ...
        <div class="card p-3">
            <div class="row">
                <div class="col-lg-3 mt-2">
                    <form action="{{ route('create.settype') }}" method="post">
                        @csrf
                    <div class="first-name">
                        <label for="">رنگ</label>
                        <input type="text" name="title" class="form-control-one p-2">
                    </div>
                </div>
                <div class="col-lg-3 mt-2">
                    <div class="first-name mr-4">
                        <label for="">کد رنگ</label>
                        <input type="text" name="value" class="form-control-one p-2">
                    </div>
                </div>
                <div class="col-lg-3 mt-2">

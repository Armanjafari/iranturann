...
<div class="col-lg-12 text-right">
  ...
  <div class="row">
          <div class="col-lg-4">
                  <div class="form-group text-right d-lg-inline-block  mr-lg-3 mt-lg-0 mt-5 w-100">
                   ...
                   <select class="w-100 p-lg-3 p-3 form-control-4" id="exampleFormCotrolSelenct1">
  ...
  <div class="col-lg-4">
         <div  class="mr-lg-3 text-right first_name  d-lg-inline-block  w-100 mt-lg-0 mt-5">
          <label>آدرس</label>
         <input type="text" class="form-control input-lg   p-3" placeholder="آدرس خود را وارد نمایید">
         </div>
  </div>
  <div class="col-lg-4 mt-5 mt-sm-0">
          <div class="  text-right first_name  d-lg-inline-block w-100">
                  <label>شماره موبایل</label>
                 <input type="text" class="form-control input-lg  form-control-2 p-3" placeholder="شماره موبایل خود راوارد نمایید">
                 </div>
          </div>
  </div>
          ...
          <div class="row">
                  <div class="col-lg-4">
                               <div class="  text-right first_name  d-lg-inline-block w-100">
                                      ...
                                      <input type="text" class="form-control input-lg  form-control-2 p-3" placeholder="صنف خود راوارد کنید">
                                      </div>
                               </div>
                               </div>

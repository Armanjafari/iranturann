...
<main class="mt-3">
    <div class="col-lg-12 pr-3">
      <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
        ...
        <li class="nav-item">
          <a class="nav-link  pr-2 pl-2 table-seler4 active" id="pills-home-tab" data-toggle="pill" href="#pills-home" role="tab" aria-controls="pills-home" aria-selected="true">کل سفارشات</a>
        </li>
      </ul>

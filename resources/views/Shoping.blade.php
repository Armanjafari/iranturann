...
<main>
<div class="row">
        <div class="card-header text-center mt-5 card-header-product w-100 pt-5 pb-5"><a class="new-product">فروشگاه های مرکز خرید بازار بزرگ لارستان</a></div>
    ...
    <div class="card card-shopping2">
        <div class="card-body text-center">
            ...
            <form action="">
             ...
             <caption><a href="#">بوتیک بیت باکس</a></caption><br>
            <div class="mt-2">

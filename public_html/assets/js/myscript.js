...
var names = ["لار", "گراش", "اوز"]; //Find the input search box

var search = document.getElementById("searchCoin"); //Find every item inside the dropdown
...
function buildDropDown(values) {
  ...
  $('#menuItems').append(contents.join("")); //Hide the row that shows no items were found
...
buildDropDown(names); // $(window).resize(function (){
//     $(document).scroll(function(){
//       if ($(window).width() < 768) {
...
module.exports = __webpack_require__(/*! /home/arman/projects/development/resources/js/myscript.js */"./resources/js/myscript.js");

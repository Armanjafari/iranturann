    ...
    <div class="container-fluid mb-5">
        <div class="row mb-5">
            ...
            <!-- start text seller -->
                ...
                <form action="">
                    <button type="submit" class="font7 p-2 seller-text mr-2 mt-3">{{ $seller->market_name }}</button>
                    <a href="{{ $seller->app ?? '' }}" class="font7 p-2 seller-text mr-2 mt-3">لینک دانلوداپلیکیشن</a>
                    <button type="submit" class="font7 p-2 seller-text mr-2 mt-3">{{ $seller->user->phone_number }}</button>
                 </form>
   
            <!-- end text seller -->
            <!-- start icons instagram and whatsapp-->
            <a href="{{'https://instagram.com/' . $market->instagram ?? ''}}">
               <img src="img/svg/insta.svg" alt="" class="Social-Networks mr-2 mt-3"></a>
               <a href="{{'https://wa.me/+98' . $market->user->phone_number}}">
                   <img src="img/svg/whatsapp-icon.svg" alt="" class="Social-Networks mr-2 mt-3"> </a>
        </div>
    </div>
